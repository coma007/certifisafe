        ...
        >
            {({ errors, touched, setFieldValue }) => (
                <Form>
                    ...
                    <ErrorMsg val={errors["new password"]} customClass={PasswordRecoveryFormCSS.margin} />
                    ...
                    <ErrorMsg val={errors["confirm password"]} customClass={PasswordRecoveryFormCSS.margin} />
