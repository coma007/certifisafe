...
const Menu = () => {
    return (
        <div className={MenuCSS.menu}>
            ...
            <MenuItem className={MenuCSS.margin} tooltipText="Verify certificate" tooltip={true} image={Verify} path="" />
            ...
            <MenuItem className={MenuCSS.nonMainOption} tooltipText="Sign out" tooltip={true} image={Logout} path="" />
        </div>
    )
}
